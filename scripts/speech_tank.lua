...
STRINGS.NAMES.TANK_CHAIN_ARMOR = "锁链胸甲"
STRINGS.RECIPE_DESC.TANK_LUXURY_SANDWICH = "看起来很好吃"
STRINGS.NAMES.TANK_FALLEN_DATA = "数据块"
STRINGS.NAMES.TANK_CHAIN_NOACTIVATED = "一坨锁链"
STRINGS.RECIPE_DESC.TANK_CHAIN_NOACTIVATED = "一条未激活的锁链，需要消耗大量数据才能启动"
STRINGS.NAMES.TANK_CHAIN_ACTIVATED = "已激活的 一坨锁链"
...
STRINGS.TANK_FALLEN_DATA_USED_BY_OTHERS = "什么感觉都没有。"--其他人捡到tank的数据块
STRINGS.TANK_FELT_STRANGE_ENERGY = "我不喜欢这些奇怪的能量……他们对我好陌生"
STRINGS.TANK_REVIVER_FEAR = "够了...这次..不想再拿着了"
STRINGS.TANK_FIRST_GET_BLOOD = "温暖的血液！"
STRINGS.TANK_NOT_ENOUGH_DATA = "好像还差点什么"
STRINGS.TANK_NOT_FOR_ME = "这个东西好像不是我能掌握的"
...
return {
	...
	DESCRIBE =
	{
        ...
        BATWING = "看看这吓人的翅膀嘿。",
        BATWING_COOKED = "一点也不吓人了...还有点诱惑的感觉...啊...",
        ...
        PITCHFORK = "草叉子嘛。",
        PLANTMEAT = "这算肉吗？",
        PLANTMEAT_COOKED = "我觉得得思考下这是素的还是荤的了。",
        PLANT_NORMAL =
        {
            GENERIC = "Leafy!",
		...
		HUMANMEAT = "啊...凭感觉这就不是很好...真的。",
		HUMANMEAT_COOKED = "你会信吗 这种类似的东西我恐怕吃过太多了。",
		HUMANMEAT_DRIED = "已经麻木了啊..哈。",
